    ...
    <div class="material c">
        <div class="material-lt">
            <div class="material-hd c">
                <div class="material-hd-lt">全部视频</div>
                <div class="material-hd-rt">
                    <div class="material-upload"><script>var materialVideoUrl='<?php echo $this->createUrl('gfMaterial/upvideo', array('group_id'=>$group_id));?>';we.materialVideo();</script></div>
                    <span class="msg">格式支持mp4，文件大小不超过500M</span>
                </div>
            </div><!--material-hd end-->
            <div class="material-bar c">
                ...
                <a class="btn" href="<?php echo $this->createUrl('videoCreate');?>"><i class="fa fa-plus"></i>添加</a>
            </div><!--material-bar end-->
            <div class="material-video c">
                <ul id="material-main" class="c">
                    <?php foreach($arclist as $v){ ?>
                    <li>
                        <div class="pic"><a href="<?php echo $v->v_file_path;?><?php echo $v->v_name;?>" target="_blank"><img src="<?php echo SITE_PATH;?>/static/admin/img/i-video.png"></a></div>
                        <div class="title">
                        ...
                        <div class="bar">
                            ...
                            <a class="fa fa-bars" href="<?php echo $this->createUrl('videoUpdate', array('id'=>$v->id));?>"></a>
        ...
        <div class="material-rt">
            <div class="material-group">
                <a<?php if($group_id==0){?> class="current"<?php }?> href="<?php echo $this->createUrl('gfMaterial/'.$action);?>">全部视频<span>(<?php echo $all_num;?>)</span></a>
                ...
                <a<?php if($group_id==$v->id){?> class="current"<?php }?> href="<?php echo $this->createUrl('gfMaterial/'.$action, array('group_id'=>$v->id));?>"><?php echo $v->group_name;?><span>(<?php echo GfMaterial::model()->getNum($v->id,253);?>)</span></a>
                <?php } ?>
            </div>
