...
//$users = User::find()->joinWith('books')->all();
    ...
    public function actioncourse($keywords = '') {
        $data = array();
        $model = ClubNews::model();
        $criteria = new CDbCriteria;
        ...
        parent::_list($model, $criteria, 'course', $data);
    }
    ...
    public function actiongetLocation() {
        ...
        $criteria = new CDbCriteria;
        $criteria->condition = '1=1';
        $criteria->select = 'id as select_id,name as select_title,pid as select_pid';
        //parent::_list($model, $criteria, 'getLocation', $data);
    }
