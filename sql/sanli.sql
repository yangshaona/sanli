...
-- ----------------------------
INSERT INTO `base_city` VALUES ('226', '0', '', '', '全选');
INSERT INTO `base_city` VALUES ('227', '1', '2020-2021', '2020', '2020-2021');
INSERT INTO `base_city` VALUES ('228', '2', '2021-2022', '2021', '2021-2022');
INSERT INTO `base_city` VALUES ('229', '3', '2022-2023', '2022', '2022-2023');
INSERT INTO `base_city` VALUES ('230', '4', '2023-2024', '2023', '2023-2024');
...
-- ----------------------------
INSERT INTO `base_country` VALUES ('226', '0', '', '', '全选');
INSERT INTO `base_country` VALUES ('227', '1', '2020-2021', '2020', '2020-2021');
INSERT INTO `base_country` VALUES ('228', '2', '2021-2022', '2021', '2021-2022');
INSERT INTO `base_country` VALUES ('229', '3', '2022-2023', '2022', '2022-2023');
INSERT INTO `base_country` VALUES ('230', '4', '2023-2024', '2023', '2023-2024');
...
-- ----------------------------
INSERT INTO `base_province` VALUES ('226', '0', '', '', '全选');
INSERT INTO `base_province` VALUES ('227', '1', '2020-2021', '2020', '2020-2021');
INSERT INTO `base_province` VALUES ('228', '2', '2021-2022', '2021', '2021-2022');
INSERT INTO `base_province` VALUES ('229', '3', '2022-2023', '2022', '2022-2023');
INSERT INTO `base_province` VALUES ('230', '4', '2023-2024', '2023', '2023-2024');
...
CREATE TABLE `club_list` (
  ...
  `sort` char(20) DEFAULT '' COMMENT '类型',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `club_list` VALUES ('1', '1社区', '2021/10/27/1_61794c962f5350.07859517.jpg', '李达良', '1', '1', '社区');
INSERT INTO `club_list` VALUES ('2', '华南师范大学附属中学', '2021/12/01/1_61a6e0d5e23de1.76360909.jpg', 'gjy', '1', '1', '学校');
INSERT INTO `club_list` VALUES ('5', '2社区', '', '', '', '', '社区');
...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES ('1', '乡村振兴看福建｜城郊乡：“一根参”的成长与使命', '乡村振兴看福建｜城郊乡：“一根参”的成长与使命', '<p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">编者按：</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">福建“八山一水一分田”，发展特色现代农业的资源禀赋得天独厚。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">近年来，福建走特色路、打特色牌，发展茶叶、蔬菜、水果、水产、食用菌等十大乡村特色产业，已走出一条独具福建特色的乡村产业振兴之路。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">为了讲好福建产业富民故事，传播八闽乡村振兴声音，在中央广播电视总台福建总站与福建省农业农村厅的指导下，央广网福建频道经过两个月的实地调研采访，从11月16日起推出“乡村振兴看福建|特色小镇的产业富民故事”系列报道。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">眼底幽妍地，人间长寿乡。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">柘荣县是国家生态文明建设示范县，位于福建省东北部，是中国长寿之乡，也是全国最大、最活跃的太子参产销区。而城郊乡又是柘荣太子参的核心产区。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">城郊乡人工栽培太子参已有近百年历史，优越的生态环境和宜人的气候为太子参生长提供了得天独厚的自然条件。</span></p><p><img src=\"https://pics7.baidu.com/feed/b58f8c5494eef01f09c567c97c49e52cbd317d2d.jpeg?token=2b3a9bed59ae1501434736885c4cc9b7\" class=\"_3yZQZ9OxCCD0QVw16rnEsS\" style=\"border: 0px; width: 599px; border-radius: 13px;\" width=\"640\"/></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">天人药业太子参基地航拍图（央广网发 天人药业供图）</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">乡村振兴的“锚点”</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">作为“中国太子参之乡”，城郊乡的太子参产业与脱贫攻坚、乡村振兴密切相关。种植太子参一直是城郊乡农民的重要收入来源。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">柘荣县太子参年种植面积超过3万亩，产销量占全国的2/3以上。目前，该乡太子参种植面积占柘荣县的1/3，全产业链产值达8.5亿元。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">近年来，城郊乡大力推广“公司+协会+专业合作社+基地+农户”的经营模式，全县首家天人际会种植产业联合体通过搭建中药材种植、加工炮制、包装运输、仓储寄存、代销贸易、质量追溯、大数据管理等一体化系列服务平台，进行联农带农协同发展。</span></p><p><img src=\"https://pics6.baidu.com/feed/cb8065380cd79123316212523883258bb3b78053.jpeg?token=afe5148024a475bc6bc8ccb3902a2736\" class=\"_3yZQZ9OxCCD0QVw16rnEsS\" style=\"border: 0px; width: 599px; border-radius: 13px;\" width=\"640\"/></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">富溪太子参园（央广网发 吴霖摄）</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">今年51岁的林斌斌是城郊乡际头村最大的种植户，同时也是省级家庭农场示范场的农场主。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">“我种植太子参20多年了，近几年综合天气等原因，收成最好的是2020年，那年我种植了10多亩，每亩收成300多斤，总共收了4000多斤，一共卖了10多万元。”林斌斌告诉记者。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">相比其他种植户每亩200多斤的产量，林斌斌种植的太子参每亩产量能达到300多斤。作为太子参的老种植户，林斌斌经常将自己的经验分享给其他种植户，偶尔还客串一下“科特派”的角色。</span></p><p><img src=\"https://pics3.baidu.com/feed/9922720e0cf3d7ca031ebf1a6aa8c2006a63a937.jpeg?token=53979650cb79ceb736a838851e6cce1f\" class=\"_3yZQZ9OxCCD0QVw16rnEsS\" style=\"border: 0px; width: 599px; border-radius: 13px;\" width=\"640\"/></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">太子参迎来丰收，种植户正在晾晒，脸上露出喜悦的笑容（央广网发 城郊乡人民政府供图）</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">据了解，在城郊乡，像林斌斌这样的种植大户还有很多。近年来，城郊乡聚焦农业特色产业，创新农业生产经营体制，培育省级示范社、家庭农场8家，带动蓝莓、葡萄、猕猴桃、水蜜桃、覆盆子等特色水果种植面积达4000亩以上，推进农业产业规模化、标准化、品牌化发展，促进农民增收致富，加快乡村振兴的步伐。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">2020年9月28日，为了支持太子参产业发展，工商银行宁德分行为当地太子参商户成功发放了第一笔金额为270万元的“太子参贷”。这也是继“海参仓单贷”、“大黄鱼仓单贷”、“鲍鱼仓单贷”后该行创新推出的仓单质押类普惠金融创新模式系列产品。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">科技助力，产业向价值链高端迈进</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">2019年，农业农村部“产业强镇”项目花落柘荣县城郊乡，为柘荣太子参产业发展装上了新引擎。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">乡村要振兴，产业是支撑。产业的发展离不开科技的助力，为了将以太子参为主导产业的生物医药循环经济做大做强，2020年12月，太子参植物工厂“天人太子参植物工厂”在城郊乡投产运行。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">该工厂融合了现代生物技术与智能信息技术，为生产绿色、优质、安全的中药材提供了有力保障。其中，城郊乡农业产业强镇示范建设项目的子项目——天人太子参植物工厂AI果项目实现了太子参脱毒苗规模化生产，满足5000亩良种繁育基地建设需要。</span></p><p><img src=\"https://pics0.baidu.com/feed/38dbb6fd5266d0163b5230f7039ca80e37fa35e2.jpeg?token=d71ddf69b57f57a2f98c1e1cba95a53e\" class=\"_3yZQZ9OxCCD0QVw16rnEsS\" style=\"border: 0px; width: 599px; border-radius: 13px;\" width=\"640\"/></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">天人药业总工程师江慧容在育种基地查看太子参种苗生长情况（央广网记者 罗晓英摄）</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">“我们从2015年开始建立种子资源圃，跟以往传统的种植方法相比，目前选育出来的种源‘天抗1号’在选育的时候就将叶斑病和花叶病的病毒剥离，以此减少太子参在田间生长期间的打药次数，从而提升太子参的品质也让种植户增收，产量能增加20%到30%。”天人药业总工程师江慧容说。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">据了解，天人药业统一向种植户提供种源清晰、明确的“天抗1号”脱病毒种苗，年生产800万粒，可满足全县太子参种苗供应，由此实现了太子参种源统一管理，种苗统一供应，保障了太子参种业源头绿色、优质、安全、环保。此外，天人药业还为种植户免费提供冷链仓库，供种植户完好保存太子参，解决太子参储存难点。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">“2020年我们采购了8000万元的太子参，今年受茶产业的冲击，目前收了3、4千万元，后期还会继续采购。我们的联合体成员可以通过两种销售运营模式，第一是订单合作模式，签订太子参收购合同，联合体进行统一销售；第二是采用联合体成员基地共建合作模式，基地产出的鲜参，联合体在采收前一个月进行采样检测，检测报告合格后，联合体依据当前行情价，签订优质优价订单收购合同。”天人药业助理总经理陈阿琴介绍称。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">目前，城郊乡以天人药业、力捷迅、贝迪药业等为代表的一批太子参深加工企业开始向价值链高端迈进，产品覆盖化学制剂、中成药、中药饮片、医疗器械和兽药等多个领域。</span></p><p><img src=\"https://pics5.baidu.com/feed/b03533fa828ba61e45425105dd83eb03314e59a9.jpeg?token=b79fa2c24e7117051f25e54486aae1d8\" class=\"_3yZQZ9OxCCD0QVw16rnEsS\" style=\"border: 0px; width: 599px; border-radius: 13px;\" width=\"640\"/></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">农户正在参园中忙碌（央广网发 天人药业供图）</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">“一地两用，双轮驱动”</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">近年来，随着茶叶收益的凸显，为了推动农业高质量发展，提升土地综合收益，城郊乡开始探索“一地两用”——茶叶套种太子参的模式。随着新模式的广泛推广，城郊乡已初步形成太子参与茶产业“双轮驱动”的格局，进一步夯实了乡村振兴的产业根基。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">“为助力柘荣太子参产业发展，柘荣县先后制定出台了《关于加快太子参产业发展的若干意见》等产业发展扶持政策。安排了1000万元的特色农业发展专项资金，通过‘以奖代补’的形式扶持发展包括太子参产业在内的特色农业。乡党委、政府也以产业强镇建设为契机，支持天人药业建设天人太子参植物工厂AI果，进一步完善我县太子参全产业链。”城郊乡乡长游奇锋表示。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">在做大做强太子参和茶叶等主导产业的同时，城郊乡充分挖掘其他资源优势，打造生态农业旅游、发展水果采摘等多种辅助产业。以剪纸特色村靴岭尾村为代表的“文创农旅”多重融合的乡村发展模式正在城郊乡悄然兴起。</span></p><p><img src=\"https://pics1.baidu.com/feed/8694a4c27d1ed21b1164867936d9a1cd50da3f39.jpeg?token=930a6c0da55075ba67c32ab1d8342e0f\" class=\"_3yZQZ9OxCCD0QVw16rnEsS\" style=\"border: 0px; width: 599px; border-radius: 13px;\" width=\"640\"/></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">参园晨曦（央广网发 吴霖摄）</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">走进环境清新的靴岭尾村，剪纸文化气息扑面而来。在靴岭尾村，家家户户都保存着传统剪纸习俗，随着剪纸艺术的传承与发展，涌现出了袁秀莹、郑平芳、袁作干等一批优秀民间艺人。靴岭尾村“文创田园”的打造，已成为助力该村振兴发展的动力。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">近年来，城郊乡通过推广标准化种植、拓展产业链等措施，全力推动太子参产业发展，并将产业发展与乡村振兴有效衔接，切实保障了农民的稳定增收。</span></p><p style=\"margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow-y: auto; max-width: 100%; line-height: 24px;\"><span class=\"bjh-p\" style=\"max-width: 100%;\">从曾经的穷乡僻壤到如今的诗意田园，当前，城郊乡以省级乡村振兴特色乡镇建设为契机，以产业发展为基础，以农旅融合发展为抓手，正在走出一条一二三产融合发展的乡村振兴之路。（央广网记者 罗晓英）</span></p><p><br style=\"white-space: normal;\"/></p><p><br/></p>', '2021-11-28 21:03:39', '2021-12-04 21:03:49', '6666', '2021/12/01/1_61a6dde464afb2.15315316.jpg', null, '', '2021-11-29 21:03:54', '2021-11-30 21:03:56', '3', '42', '2020-2021', '上学期', '', '', '');
INSERT INTO `course` VALUES ('2', '452', '452', '<p>1231231231</p>', '2021-12-14 15:48:17', '2021-12-23 15:48:12', '6666', '', null, '', '2021-12-06 15:48:21', '2021-12-10 15:48:25', '0', '452', '2020-2021', '上学期', '', '2', '华南师范大学附属中学');
INSERT INTO `course` VALUES ('5', '11112132', '', '<p>2a3df2ad</p>', '2021-12-01 21:03:39', '2021-12-15 21:03:49', '6666', '', null, '111', '2021-12-20 21:03:54', '2021-12-23 21:03:56', '0', null, '2020-2021', '上学期', null, '2', '华南师范大学附属中学');
INSERT INTO `course` VALUES ('6', '深圳研学', '深圳研学', '<section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); margin: 0px; padding: 0px; font-family: 微软雅黑;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"88503\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><section style=\"margin: 10px auto; padding: 2px; box-sizing: border-box;\"><section style=\"margin: 0px 0px 0px 10px; padding: 0px; overflow-wrap: break-word; border-bottom: 2px dashed rgb(128, 177, 53); min-height: 36px; display: inline-block; line-height: 36px; box-sizing: border-box;\"><span class=\"135brush\" data-brushtype=\"text\" style=\"margin: 0px; padding: 0px; color: rgb(128, 177, 53); font-size: 18px; display: inline-block;\"><strong style=\"margin: 0px; padding: 0px;\"><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: 微软雅黑, sans-serif;\">登莲花山公园</span><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: Tahoma, sans-serif;\">&nbsp;&nbsp;&nbsp;&nbsp;</span><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: 微软雅黑, sans-serif;\">瞻仰邓小平铜像</span></strong></span></section></section></section><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">建于</span><span style=\"margin: 0px; padding: 0px;\">1992</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">年</span><span style=\"margin: 0px; padding: 0px;\">10</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">月</span><span style=\"margin: 0px; padding: 0px;\">10</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">日，坐落于公园主峰的山顶广场，海拔</span><span style=\"margin: 0px; padding: 0px;\">106</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">米，面积达</span><span style=\"margin: 0px; padding: 0px;\">4000</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">平方米，绿色、环保、自然、和谐是整个公园的基调。邓小平铜像矗立在广场中央，中心区美景尽收眼底。在山顶广场已成为广大市民和中外游人缅怀一代伟人风采、饱览中心区景色的最好去处。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">主要活动：敬献花圈，在邓小平铜像前宣誓；欣赏地王大厦、深圳书城、赛格广场、华强北、市民中心、高交会馆、华侨城等特区风光，远望香港。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\"><br style=\"margin: 0px; padding: 0px;\"/></span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\"></span></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155845272.jpg\" title=\"155845272.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><p style=\"margin: 0px auto; padding: 0px;\"><br/></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155845660.jpg\" title=\"155845660.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"margin: 0px; padding: 0px;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"16401\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><p style=\"margin: 0px auto; padding: 0px; clear: both; text-align: center;\"><img data-ratio=\"0.01875\" src=\"https://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjEIibB1UYw1VMPzscNxReKZVxEh23qB9KgPqFq3uoyBy3M93PcFOunrvjkYVrtfvXMworbBuWAZ4A/0\" data-w=\"640\" title=\"金属质感分割线\" style=\"margin: 0px; padding: 0px; vertical-align: middle; border: none; max-width: 100%; display: inline; height: auto !important;\"/></p></section></section></section><p><br/></p><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); margin: 0px; padding: 0px; font-family: 微软雅黑;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"88503\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><section style=\"margin: 10px auto; padding: 2px; box-sizing: border-box;\"><section style=\"margin: 0px; padding: 0px; width: 60px; height: 40px; text-align: center; font-size: 2em; color: rgb(255, 255, 255); float: left; line-height: 40px; background-image: linear-gradient(-45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(135deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(-135deg, transparent 14.14px, rgb(139, 183, 72) 0px); background-size: 50% 50%, 50% 50%, 50% 50%, 50% 50%; background-position: 100% 100%, 0% 100%, 0% 0%, 100% 0%; background-repeat: no-repeat, no-repeat, no-repeat, no-repeat;\"><section class=\"autonum\" data-original-title=\"\" title=\"\" style=\"margin: 0px; padding: 0px;\">2</section></section><section style=\"margin: 0px 0px 0px 10px; padding: 0px; overflow-wrap: break-word; border-bottom: 2px dashed rgb(128, 177, 53); min-height: 36px; display: inline-block; line-height: 36px; box-sizing: border-box;\"><span class=\"135brush\" data-brushtype=\"text\" style=\"margin: 0px; padding: 0px; color: rgb(128, 177, 53); font-size: 18px; display: inline-block;\"><strong style=\"margin: 0px; padding: 0px;\"><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: 微软雅黑, sans-serif;\">南岭村求水山风景区</span></strong></span></section></section></section><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">中国第一村，全国文明示范村，享誉全国的红色景点、爱国主义教育场所；在这里，江泽民同志曾号召“致富思源、富而思进”，胡锦涛总书记也提出了“不自满、不停步、不松懈”的要求。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">南岭求水山风景区，建于</span><span style=\"margin: 0px; padding: 0px;\">1995</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">年，由南岭村直接投资建造，投资</span><span style=\"margin: 0px; padding: 0px;\">6000</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">多万元，占地</span><span style=\"margin: 0px; padding: 0px;\">53</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">万平方米，主峰求水顶海拔</span><span style=\"margin: 0px; padding: 0px;\">253.26</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">米，主峰可尽览深圳水库景色和眺望深圳美景。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">主要活动项目：客家民俗博览园、致富思源展厅、伟人像章展、中国历史长廊、高空缆车、穿越长城、百鸟乐园、长征微缩景观。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px;\">&nbsp;</span></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155908913.jpg\" title=\"155908913.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><p style=\"margin: 0px auto; padding: 0px;\"><br/></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155908450.jpg\" title=\"155908450.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><section data-role=\"paragraph\" class=\"_135editor\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"margin: 0px; padding: 0px;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"16401\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><p style=\"margin: 0px auto; padding: 0px; clear: both; text-align: center;\"><img data-ratio=\"0.01875\" src=\"https://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjEIibB1UYw1VMPzscNxReKZVxEh23qB9KgPqFq3uoyBy3M93PcFOunrvjkYVrtfvXMworbBuWAZ4A/0\" data-w=\"640\" title=\"金属质感分割线\" style=\"margin: 0px; padding: 0px; vertical-align: middle; border: none; max-width: 100%; display: inline; height: auto !important;\"/></p></section></section></section></section><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); margin: 0px; padding: 0px; font-family: 微软雅黑;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"88503\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><section style=\"margin: 10px auto; padding: 2px; box-sizing: border-box;\"><section style=\"margin: 0px; padding: 0px; width: 60px; height: 40px; text-align: center; font-size: 2em; color: rgb(255, 255, 255); float: left; line-height: 40px; background-image: linear-gradient(-45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(135deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(-135deg, transparent 14.14px, rgb(139, 183, 72) 0px); background-size: 50% 50%, 50% 50%, 50% 50%, 50% 50%; background-position: 100% 100%, 0% 100%, 0% 0%, 100% 0%; background-repeat: no-repeat, no-repeat, no-repeat, no-repeat;\"><section class=\"autonum\" data-original-title=\"\" title=\"\" style=\"margin: 0px; padding: 0px;\">3</section></section><section style=\"margin: 0px 0px 0px 10px; padding: 0px; overflow-wrap: break-word; border-bottom: 2px dashed rgb(128, 177, 53); min-height: 36px; display: inline-block; line-height: 36px; box-sizing: border-box;\"><span class=\"135brush\" data-brushtype=\"text\" style=\"margin: 0px; padding: 0px; color: rgb(128, 177, 53); font-size: 18px; display: inline-block;\"><strong style=\"margin: 0px; padding: 0px;\"><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: 微软雅黑, sans-serif;\">大梅沙海滨公园</span></strong></span></section></section></section><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">位于深圳特区东部的盐田港与小梅沙之间，风光旖旎的大鹏湾畔。拥有深圳最长的海滩，于</span><span style=\"margin: 0px; padding: 0px;\">1999</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">年</span><span style=\"margin: 0px; padding: 0px;\">6</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">月</span><span style=\"margin: 0px; padding: 0px;\">18</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">日建成，建设总投入高达</span><span style=\"margin: 0px; padding: 0px;\">1.2</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">亿元，是广东省</span><span style=\"margin: 0px; padding: 0px;\">5A</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">级旅游景区。这里三面环山，中间开阔平缓，一面临海，</span><span style=\"margin: 0px; padding: 0px;\">1800</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">米的沙滩就镶嵌在这青山碧海之间</span><span style=\"margin: 0px; padding: 0px;\">,</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">海水清澈，沙滩广阔，沙质细软。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px;\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">主要活动：游大梅沙海滨公园，看大海、踏细浪、海滩拔河、堆沙雕、有滑水索道、摩托艇、沙滩车、水上降落伞、沙滩排球、沙滩足球等众多游乐项目。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\"><br style=\"margin: 0px; padding: 0px;\"/></span></p><section data-role=\"paragraph\" class=\"_135editor\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155934890.jpg\" title=\"155934890.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><p style=\"margin: 0px auto; padding: 0px;\"><br/></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155935282.jpg\" title=\"155935282.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"margin: 0px; padding: 0px;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"16401\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><p style=\"margin: 0px auto; padding: 0px; clear: both; text-align: center;\"><img data-ratio=\"0.01875\" src=\"https://mmbiz.qlogo.cn/mmbiz/cZV2hRpuAPjEIibB1UYw1VMPzscNxReKZVxEh23qB9KgPqFq3uoyBy3M93PcFOunrvjkYVrtfvXMworbBuWAZ4A/0\" data-w=\"640\" title=\"金属质感分割线\" style=\"margin: 0px; padding: 0px; vertical-align: middle; border: none; max-width: 100%; display: inline; height: auto !important;\"/></p></section></section></section></section><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); margin: 0px; padding: 0px; font-family: 微软雅黑;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"88503\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><section style=\"margin: 10px auto; padding: 2px; box-sizing: border-box;\"><section style=\"margin: 0px; padding: 0px; width: 60px; height: 40px; text-align: center; font-size: 2em; color: rgb(255, 255, 255); float: left; line-height: 40px; background-image: linear-gradient(-45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(135deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(-135deg, transparent 14.14px, rgb(139, 183, 72) 0px); background-size: 50% 50%, 50% 50%, 50% 50%, 50% 50%; background-position: 100% 100%, 0% 100%, 0% 0%, 100% 0%; background-repeat: no-repeat, no-repeat, no-repeat, no-repeat;\"><section class=\"autonum\" data-original-title=\"\" title=\"\" style=\"margin: 0px; padding: 0px;\">4</section></section><section style=\"margin: 0px 0px 0px 10px; padding: 0px; overflow-wrap: break-word; border-bottom: 2px dashed rgb(128, 177, 53); min-height: 36px; display: inline-block; line-height: 36px; box-sizing: border-box;\"><span class=\"135brush\" data-brushtype=\"text\" style=\"margin: 0px; padding: 0px; color: rgb(128, 177, 53); font-size: 18px; display: inline-block;\"><strong style=\"margin: 0px; padding: 0px;\"><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: 微软雅黑, sans-serif;\">大鹏所城</span></strong></span></section></section></section><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">“深圳八景”之一，深圳今又名“鹏城”即源于此。大鹏所城历史悠久，鸦片战争的第一枪是所城驻军在香港九龙打响。将门之风，展露无遗。</span><span style=\"margin: 0px; padding: 0px; font-family: Tahoma, sans-serif;\">2001</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">年</span><span style=\"margin: 0px; padding: 0px; font-family: Tahoma, sans-serif;\">6</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">月</span><span style=\"margin: 0px; padding: 0px; font-family: Tahoma, sans-serif;\">25</span><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">日，大鹏所城被国务院公布为“全国重点文物保护单位”。</span></p><section data-role=\"paragraph\" class=\"_135editor\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155955579.jpg\" title=\"155955579.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><p style=\"margin: 0px auto; padding: 0px;\"><br/></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/155955125.jpg\" title=\"155955125.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"margin: 0px; padding: 0px;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"16401\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><p style=\"margin: 0px auto; padding: 0px; clear: both; text-align: center;\"><br/></p></section></section></section></section><section data-role=\"outer\" label=\"Powered by 135editor.com\" style=\"color: rgb(51, 51, 51); white-space: normal; background-color: rgb(255, 255, 255); margin: 0px; padding: 0px; font-family: 微软雅黑;\"><section class=\"_135editor\" data-tools=\"135编辑器\" data-id=\"88503\" style=\"margin: 0px; padding: 0px; border-width: 0px; border-style: none; border-color: initial; box-sizing: border-box;\"><section style=\"margin: 10px auto; padding: 2px; box-sizing: border-box;\"><section style=\"margin: 0px; padding: 0px; width: 60px; height: 40px; text-align: center; font-size: 2em; color: rgb(255, 255, 255); float: left; line-height: 40px; background-image: linear-gradient(-45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(45deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(135deg, transparent 14.14px, rgb(139, 183, 72) 0px), linear-gradient(-135deg, transparent 14.14px, rgb(139, 183, 72) 0px); background-size: 50% 50%, 50% 50%, 50% 50%, 50% 50%; background-position: 100% 100%, 0% 100%, 0% 0%, 100% 0%; background-repeat: no-repeat, no-repeat, no-repeat, no-repeat;\"><section class=\"autonum\" data-original-title=\"\" title=\"\" style=\"margin: 0px; padding: 0px;\">5</section></section><section style=\"margin: 0px 0px 0px 10px; padding: 0px; overflow-wrap: break-word; border-bottom: 2px dashed rgb(128, 177, 53); min-height: 36px; display: inline-block; line-height: 36px; box-sizing: border-box;\"><span class=\"135brush\" data-brushtype=\"text\" style=\"margin: 0px; padding: 0px; color: rgb(128, 177, 53); font-size: 18px; display: inline-block;\"><p style=\"margin: 0px auto; padding: 0px; clear: both;\"><strong style=\"margin: 0px; padding: 0px;\"><span style=\"margin: 0px; padding: 0px; font-size: 16px; font-family: 微软雅黑, sans-serif;\">世界之窗</span></strong></p></span></section></section></section><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\">位于广东省深圳市深圳湾社区深南大道，是中国著名的缩微景区，以弘扬世界文化为宗旨，是一个把世界奇观、历史遗迹、古今名胜、民间歌舞表演融为一体的人造主题公园。</span></p><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\"><br style=\"margin: 0px; padding: 0px;\"/></span></p><p style=\"margin: 0px auto; padding: 0px; clear: both; text-indent: 2em;\"><span style=\"margin: 0px; padding: 0px; font-family: 微软雅黑, sans-serif;\"></span></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/160021435.jpg\" title=\"160021435.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p><p style=\"margin: 0px auto; padding: 0px;\"><br/></p><p style=\"margin: 0px auto; padding: 0px; text-align: center;\"><img src=\"http://www.hbsjjy.com/upload/20171205/160021816.jpg\" title=\"160021816.jpg\" style=\"margin: 0px auto; padding: 0px; vertical-align: middle; border: none;\"/></p></section><p><br/></p><p><br/></p>', '2021-12-08 09:00:00', '2021-12-15 21:03:49', '6666', '', null, '', '2021-11-29 21:03:54', '2021-12-15 00:41:17', '1', null, '2020-2021', '上学期', '', '2', '华南师范大学附属中学');
...
CREATE TABLE `course_data` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `day` int(4) DEFAULT NULL COMMENT '第几天',
  `name` varchar(40) DEFAULT '' COMMENT '日程名称',
  `start_time` time(6) DEFAULT NULL COMMENT '开始时间',
  `end_time` time(6) DEFAULT NULL COMMENT '结束时间',
  `location` varchar(40) DEFAULT '' COMMENT '地点',
  `content` longtext COMMENT '活动内容',
  `work` longtext COMMENT '作业',
  `course_name` varchar(80) DEFAULT '' COMMENT '课程名称',
...
-- ----------------------------
INSERT INTO `course_data` VALUES ('2', '11', '11', '21:57:27.000000', '21:57:29.000000', '11', '11', '11', '452', '2020-2021', '下学期');
INSERT INTO `course_data` VALUES ('3', '1', '1', '21:59:01.000000', '21:59:03.000000', '1', '1', '1', '452', '2020-2021', '下学期');
...
INSERT INTO `registration` VALUES ('2', '2', '1', '2021-12-03 11:51:22', '0');
INSERT INTO `registration` VALUES ('3', '1', '1', '2021-12-03 11:51:29', '1');
...
CREATE TABLE `test_err` (
  ...
  PRIMARY KEY (`f_id`)
) ENGINE=InnoDB AUTO_INCREMENT=721020 DEFAULT CHARSET=utf8;
